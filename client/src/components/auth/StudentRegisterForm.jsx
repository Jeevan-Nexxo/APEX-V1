...
function StudentRegisterForm({ onBack }) {
  ...
  const validateStep1 = () => {
    ...
    if (formData.role === "student" && (!formData.college.trim() || !formData.department || !formData.year_of_study)) {
      toast.error("Please fill in your college, department, and year of study."); return false;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      form.append("year_of_study", formData.year_of_study);
  ...
  return (
    ...
    >
      ...
      <h2 className="text-3xl font-bold text-foreground text-center">Student <span className="text-primary">Registration</span></h2>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        {step === 1 && (
          <>
            ...
            <input type="tel" name="mobile" placeholder="Mobile Number" value={formData.mobile} onChange={handleChange} className={inputClass} />
            <input type="text" name="college" placeholder="College Name" value={formData.college} onChange={handleChange} className={inputClass} required />
            ...
            <select name="year_of_study" value={formData.year_of_study} onChange={handleChange} className={inputClass} required>
